...
CREATE TABLE SPRINGBOOT.ROLES (
	AUTHORITY VARCHAR2(50) NOT NULL,
	DESCRIPTION VARCHAR2(100),
	AUTH_LEVEL INTEGER NOT NULL
);

ALTER TABLE SPRINGBOOT.ROLES
...
ALTER TABLE SPRINGBOOT.AUTHORITIES
ADD CONSTRAINT AUTHORITIES_PK PRIMARY KEY (MEMBER_EMAIL,ROLES_AUTHORITY)
ENABLE;

ALTER TABLE SPRINGBOOT.AUTHORITIES ADD CONSTRAINT FK_TBL_MEMBER FOREIGN KEY (MEMBER_EMAIL) REFERENCES SPRINGBOOT.TBL_MEMBER(EMAIL);

ALTER TABLE SPRINGBOOT.AUTHORITIES ADD CONSTRAINT FK_ROLES FOREIGN KEY (ROLES_AUTHORITY) REFERENCES SPRINGBOOT.ROLES(AUTHORITY);
